  ...
  <div class="card-premium p-6 flex flex-col justify-between h-full animate-fade-in-up">
    <div class="flex justify-between items-start mb-4">
      <div>
        ...
        <h3 class="text-3xl font-display font-bold text-white tracking-tight">${value}</h3>
      </div>
    ...
    <div class="flex items-center gap-2 text-sm font-medium">
      <span class="${trend === 'up' ? 'text-emerald-400 bg-emerald-400/10' : 'text-rose-400 bg-rose-400/10'} px-2 py-0.5 rounded-md border border-white/5 flex items-center gap-1">
        ${trend === 'up' ? '↑' : '↓'} ${trendValue}
      </span>
